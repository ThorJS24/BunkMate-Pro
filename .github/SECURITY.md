...
- **Email**: Create a private security report or contact the maintainers via GitHub Security Advisories at [https://github.com/ThorJS24/BunkMate-Pro/security/advisories](https://github.com/ThorJS24/BunkMate-Pro/security/advisories).
